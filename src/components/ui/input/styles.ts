...
export const styles = tv({
  ...
  variants: {
    intent: {
      ...
      secondary: 'bg-stone-700 text-stone-900 placeholder:text-stone-900 hover:bg-stone-300 hover:text-stone-700 placeholder:hover:text-stone-700 focus:bg-stone-300 focus:text-stone-700 focus:placeholder:text-stone-700',
    },
    size: {
      small: 'px-4 py-2',
      medium: 'p-4',
